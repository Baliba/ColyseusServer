...
exports.DominoRoom = void 0;
const colyseus_1 = require("colyseus");
const player_1 = require("../models/player");
const user_1 = require("../models/user");
const DominoRoomState_1 = require("./schema/DominoRoomState");
class DominoRoom extends colyseus_1.Room {
    constructor() {
        super(...arguments);
        this.max_clients = 2;
    }
    onCreate(options) {
        this.setState(new DominoRoomState_1.DominoRoomState(this, 0, this.max_clients, 0.20));
    ...
    sendHandToClients(client, zoes, i) {
